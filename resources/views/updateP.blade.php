                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                    <form action="{{route('updatePD')}}" method="post">
                                        {{csrf_field()}}
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="ProductN" type="text" value="{{$ProductN}}" placeholder="Product" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="Qantity" value="{{$Qantity}}" type="text" placeholder="Quantity" />
